...
Main.Size = UDim2.fromOffset(285, 235)
...
SpeedInfo.Position = UDim2.fromOffset(15, 175)
SpeedInfo.Size = UDim2.new(1, -30, 0, 17)
...
Start.Position = UDim2.fromOffset(15, 195)
...
Stop.Position = UDim2.new(0.5, 5, 0, 195)
...
local function updateSpeed()
    ...
    if not cps then
        SpeedInfo.Text = "Enter a number, e.g. 20"
        return
    end

    cps = math.clamp(cps, 1, 1000)
    CLICK_DELAY = 1 / cps
